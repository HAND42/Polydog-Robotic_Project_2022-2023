void kinematics (int leg, float x, float y, float z) {
  ...
  if (leg == 1) {           // *front left leg*
    ...
    servo11PosTrack = (kneeAngleDegrees-90) * 25;           // positive scaler, 90 is the offset(the knee angle should be 90 degrees in the beginning), 25 is the scaling factor.
    servo7PosTrack = ((shoulderAngle1Degrees-45) * 25) + (shoulderAngle2Degrees * 25) ;       // positive scaler, 45 is the offset(the shoulder angle should be 45 degrees in the beginning),25 is the scaling factor.
